...
const Saves = () => {
  ...
  return (
    <div className="p-3">
      ...
      {fontItems?.length === 0?(<div className="flex flex-col gap-5 items-center justify-center">
        <p>Go to Font Page to View amazing Nextjs fonts</p>
        <Link href="/fontstyle" className="border px-5 py-2 shadow-sm hover:shadow-md hover:shadow-black transition-all shadow-black rounded-md">View Font</Link>
      </div>):(null)}
        {fontItems.map((item) => {
          return (
            <div
