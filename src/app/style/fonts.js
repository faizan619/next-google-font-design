...
const akshar = Akshar({ preload: false });
const albert_sans = Albert_Sans({ preload: false });
const algereya = Alegreya({ preload: false });
const aleo = Aleo({ preload: false });
const alexandria = Alexandria({ preload: false });
const alumini_sans = Alumni_Sans({ preload: false });
const andada_pro = Andada_Pro({ preload: false });
const anek_bangla = Anek_Bangla({ preload: false });
const anek_gujarati = Anek_Gujarati({ preload: false });
const anek_devanagari = Anek_Devanagari({ preload: false });
const anek_gurmukhi = Anek_Gurmukhi({ preload: false });
const anek_latin = Anek_Latin({ preload: false });
const anek_kannada = Anek_Kannada({ preload: false });
const anek_malayalam = Anek_Malayalam({ preload: false });
const anek_odia = Anek_Odia({ preload: false });
const anek_tamil = Anek_Tamil({ preload: false });
const anek_telugu = Anek_Telugu({ preload: false });
const antonio = Antonio({ preload: false });
const anuphan = Anuphan({ preload: false });
const anybody = Anybody({ preload: false });
const archivo = Archivo({ preload: false });
const archivo_narrow = Archivo_Narrow({ preload: false });
const arima = Arima({ preload: false });
const arimo = Arimo({ preload: false });
...
const baloo_bhaijaan_2 = Baloo_Bhaijaan_2({ preload: false });
const baloo_bhaina_2 = Baloo_Bhaina_2({ preload: false });
const baloo_chettan_2 = Baloo_Chettan_2({ preload: false });
const baloo_da_2 = Baloo_Da_2({ preload: false });
const baloo_paaji_2 = Baloo_Paaji_2({ preload: false });
const baloo_tamma_2 = Baloo_Tamma_2({ preload: false });
const baloo_tammudu_2 = Baloo_Tammudu_2({ preload: false });
...
const catamaran = Catamaran({ preload: false });
const caveat = Caveat({ preload: false });
const changa = Changa({ preload: false });
const chivo = Chivo({ preload: false });
const chivo_mono = Chivo_Mono({ preload: false });
const cinzel = Cinzel({ preload: false });
const climate_crisis = Climate_Crisis({ preload: false });
const comme = Comme({ preload: false });
const commissioner = Commissioner({ preload: false });
...
const edu_qld_beginner = Edu_QLD_Beginner({ preload: false });
const edu_sa_beginner = Edu_SA_Beginner({ preload: false });
const edu_tas_beginner = Edu_TAS_Beginner({ preload: false });
const edu_vic_wa_nt_beginner = Edu_VIC_WA_NT_Beginner({ preload: false });
const encode_sans = Encode_Sans({ preload: false });
const encode_sans_sc = Encode_Sans_SC({ preload: false });
const epilogue = Epilogue({ preload: false });
...
const finlandica = Finlandica({ preload: false });
const fira_code = Fira_Code({ preload: false });
const foldit = Foldit({ preload: false });
...
const gemunu_libre = Gemunu_Libre({ preload: false });
const genos = Genos({ preload: false });
const geologica = Geologica({ preload: false });
const georama = Georama({ preload: false });
const glory = Glory({ preload: false });
const gluten = Gluten({ preload: false });
...
const hedvig_letters_serif = Hedvig_Letters_Serif({ preload: false });
...
const kode_mono = Kode_Mono({ preload: false });
...
const lexend = Lexend({ preload: false });
const lexend_deca = Lexend_Deca({ preload: false });
const lexend_giga = Lexend_Giga({ preload: false });
const lexend_mega = Lexend_Mega({ preload: false });
const lexend_peta = Lexend_Peta({ preload: false });
const lexend_tera = Lexend_Tera({ preload: false });
const lexend_zetta = Lexend_Zetta({ preload: false });
const libre_bodoni = Libre_Bodoni({ preload: false });
const libre_franklin = Libre_Franklin({ preload: false });
...
const m_plus_code_latin = M_PLUS_Code_Latin({ preload: false });
const mada = Mada({ preload: false });
const manrope = Manrope({ preload: false });
const marhey = Marhey({ preload: false });
...
const noto_naskh_arabic = Noto_Naskh_Arabic({ preload: false });
const noto_nastaliq_urdu = Noto_Nastaliq_Urdu({ preload: false });
const noto_rashi_hebrew = Noto_Rashi_Hebrew({ preload: false });
const noto_sans = Noto_Sans({ preload: false });
const noto_sans_adlam = Noto_Sans_Adlam({ preload: false });
const noto_sans_adlam_unjoined = Noto_Sans_Adlam_Unjoined({ preload: false });
...
const orbitron = Orbitron({ preload: false });
...
const piazzolla = Piazzolla({ preload: false });
const pixelify_sans = Pixelify_Sans({ preload: false });
const platypi = Platypi({ preload: false });
const playfair = Playfair({ preload: false });
const playfair_display = Playfair_Display({ preload: false });
const playpen_sans = Playpen_Sans({ preload: false });
const plus_jakarta_sans = Plus_Jakarta_Sans({ preload: false });
const podkova = Podkova({ preload: false });
...
const rasa = Rasa({ preload: false });
const readex_pro = Readex_Pro({ preload: false });
const recursive = Recursive({ preload: false });
const red_hat_display = Red_Hat_Display({ preload: false });
const red_hat_mono = Red_Hat_Mono({ preload: false });
const red_hat_text = Red_Hat_Text({ preload: false });
const red_rose = Red_Rose({ preload: false });
const reddit_mono = Reddit_Mono({ preload: false });
const reem_kufi = Reem_Kufi({ preload: false });
const reem_kufi_fun = Reem_Kufi_Fun({ preload: false });
const rethink_sans = Rethink_Sans({ preload: false });
const roboto_condensed = Roboto_Condensed({ preload: false });
const roboto_flex = Roboto_Flex({ preload: false });
const roboto_mono = Roboto_Mono({ preload: false });
const roboto_serif = Roboto_Serif({ preload: false });
const roboto_slab = Roboto_Slab({ preload: false });
...
const schibsted_grotesk = Schibsted_Grotesk({ preload: false });
const sen = Sen({ preload: false });
const shantell_sans = Shantell_Sans({ preload: false });
const signika = Signika({ preload: false });
const sixtyfour = Sixtyfour({ preload: false });
...
const sora = Sora({ preload: false });
const source_code_pro = Source_Code_Pro({ preload: false });
const source_sans_3 = Source_Sans_3({ preload: false });
const source_serif_4 = Source_Serif_4({ preload: false });
const space_grotesk = Space_Grotesk({ preload: false });
...
const tilt_neon = Tilt_Neon({ preload: false });
const tilt_prism = Tilt_Prism({ preload: false });
...
const ysabeau = Ysabeau({ preload: false });
